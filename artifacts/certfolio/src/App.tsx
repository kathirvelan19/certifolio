...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(226, 47%, 20%)",
    colorForeground: "hsl(226, 47%, 11%)",
    colorMutedForeground: "hsl(215, 16%, 47%)",
    colorDanger: "hsl(0, 84%, 60%)",
    colorBackground: "hsl(0, 0%, 100%)",
    colorInput: "hsl(0, 0%, 100%)",
    colorInputForeground: "hsl(226, 47%, 11%)",
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <TooltipProvider>
          <Switch>
            ...
            <Route path="/upload" component={() => <ProtectedRoute component={UploadCertificate} />} />
            <Route path="/profile" component={() => <ProtectedRoute component={ProfileEdit} />} />
            <Route path="/settings" component={() => <ProtectedRoute component={ProfileEdit} />} />
            
            <Route path="/certificate/:id" component={CertificateView} />
            <Route path="/u/:username" component={PortfolioView} />
